...
const Card = ({ details, click }) => {
  
  const descriptionWords = details.description.split(' ');
  ...
  return (
    <div className='card'>
      <div className='image-container'>
        <div className="image1" style={{ backgroundImage: `url(${details.image})` }}>
          <svg className='svg_overlay' width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
